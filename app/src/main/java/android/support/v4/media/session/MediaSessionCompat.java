                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (volumeType == 2) {
                                    try {
                                        ...
                                        try {
                                            max = vp.getMaxVolume();
                                            try {
                                                controlType2 = vp.getCurrentVolume();
                                            } catch (Throwable th) {
                                                th = th;
                                                while (true) {
                                                    try {
                                    ...
                                    try {
                                        ...
                                        try {
                                            controlType2 = MediaSessionImplBase.this.mAudioManager.getStreamVolume(stream);
                                        } catch (Throwable th5) {
                                            th = th5;
                                            while (true) {
                                                break;
                                ...
                                int current = controlType2;
                                int controlType3 = controlType;
                                int max2 = max;
                                try {
                                    return new ParcelableVolumeInfo(volumeType, stream, controlType3, max2, current);
                                } catch (Throwable th7) {
                                    th = th7;
                                    while (true) {
                                        break;
