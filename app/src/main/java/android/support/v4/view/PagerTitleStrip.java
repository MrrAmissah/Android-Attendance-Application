...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        if (vgrav2 == 16) {
            ...
            prevTop2 = prevTop3;
            paddedHeight = currTop2;
            vgrav = nextTop2;
            TextView textView = this.mCurrText;
            textView.layout(currLeft, paddedHeight, halfCurrWidth2, paddedHeight + textView.getMeasuredHeight());
            int prevLeft = Math.min(paddingLeft, (currLeft - this.mScaledTextSpacing) - prevWidth);
            TextView textView2 = this.mPrevText;
            textView2.layout(prevLeft, prevTop2, prevLeft + prevWidth, prevTop2 + textView2.getMeasuredHeight());
        ...
        prevTop2 = prevTop;
        paddedHeight = currTop;
        vgrav = nextTop;
        TextView textView4 = this.mCurrText;
        textView4.layout(currLeft, paddedHeight, halfCurrWidth2, paddedHeight + textView4.getMeasuredHeight());
        int prevLeft2 = Math.min(paddingLeft, (currLeft - this.mScaledTextSpacing) - prevWidth);
        TextView textView22 = this.mPrevText;
        textView22.layout(prevLeft2, prevTop2, prevLeft2 + prevWidth, prevTop2 + textView22.getMeasuredHeight());
        int nextLeft2 = Math.max((stripWidth - paddingRight) - nextWidth, this.mScaledTextSpacing + halfCurrWidth2);
        TextView textView32 = this.mNextText;
        textView32.layout(nextLeft2, vgrav, nextLeft2 + nextWidth, vgrav + textView32.getMeasuredHeight());
        this.mLastKnownPositionOffset = positionOffset;
        this.mUpdatingPositions = false;
    }
